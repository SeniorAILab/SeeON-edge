...
def _record_payload(record: object, decision: object) -> dict[str, object]:
    ...
    return {
        ...
        "bed_state": record.machine_fields()["bed_state"],
        "boot_changed": record.boot_changed,
        "boot_changed_missing_reason": record.boot_changed_missing_reason,
        ...
        "domain_alignment": record.machine_fields()["domain_alignment"],
        "due_signal": record.machine_fields()["due_signal"],
        ...
        "person_presence": record.machine_fields()["person_presence"],
        ...
        "track_staleness": record.machine_fields()["track_staleness"],
