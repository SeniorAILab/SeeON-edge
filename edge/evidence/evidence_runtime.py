...
from edge.evidence.evidence_outbox import ClipId, EvidenceOutbox
from edge.evidence.evidence_reconciliation import (
...
class EvidenceExportRuntime:
    ...
    def notify_clip_finalized(self, clip_id: ClipId) -> None:
        """Queue one completed recorder artifact and wake delivery promptly."""
    ...
    def _run_sender(self) -> None:
        while not self._stop_event.is_set():
            ...
            except Exception:  # noqa: BLE001 - durable rows remain retryable after process errors
