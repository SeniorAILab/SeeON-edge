...
EDGE_DATABASE_SCHEMA_VERSION: Final = int(os.environ["CANARY_EDGE_DATABASE_SCHEMA_VERSION"])
EDGE_DATABASE_FORMAT_IDENTITY: Final = os.environ["CANARY_EDGE_DATABASE_FORMAT_IDENTITY"]
