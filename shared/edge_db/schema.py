...
from shared.edge_db.application_schema import APPLICATION_SCHEMA_STATEMENTS
from shared.edge_db.evidence_backfill import EVIDENCE_BACKFILL_STATEMENTS
from shared.edge_db.ownership import TABLE_FAMILIES
from shared.edge_db.review_migration import LEGACY_LABEL_MIGRATION_STATEMENTS
...
_FAMILY_INSERTS = tuple(
    "INSERT INTO schema_table_families (prefix, writer, purpose) "
    f"VALUES ('{family.prefix}', '{family.writer.value}', '{family.purpose}')"
